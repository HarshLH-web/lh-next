            ...
            <div className="px-6 sm:px-8 flex flex-col lg:flex-row max-w-6xl mx-auto pt-10 pb-10 lg:pt-16 lg:pb-16">
                <div>
                    ...
                    <ul className="text-left list-decimal px-6 space-y-1">
                        <li className="text-[1rem] leading-[1.25] md:text-lg text-left">Download the HoneyCam App <a href="https://play.google.com/store/apps/details?id=com.honeycam.app" className="underline text-blue-500">For Android</a> & <a href="https://apps.apple.com/in/app/honeycam-chat-and-match-friend/id1521957817" className="underline text-blue-500">For IOS</a></li>
