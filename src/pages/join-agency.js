                ...
                <div className="w-[90%] mx-auto max-w-6xl">
                    <div className="text-center w-full md:w-[80%] lg:w-[75%] mx-auto">
                        ...
                        <p>
                            ...
                            By registering as an Agent, you can onboard and manage broadcasters and sub-Agents under your team.
                        </p>
                        <p>
                            To register as an Agent, follow these steps:
                        </p>
                    </div>
                    <div className="flex flex-col md:flex-row items-center justify-center gap-4 lg:gap-12 py-4 lg:py-8">
                        ...
                        <div>
                            <ul className="list-decimal pl-6 space-y-2 text-lg mb-6">
                                <li>Open the Agency <a href="https://h5.ichamet.com/webH5/inviteAgent/bind.html?companyId=3338" className="text-[#9e00c2]">Registration Link</a>.</li>
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-4 lg:gap-12 py-4 lg:py-8">
                        ...
                        <div>
                            <h3 className="text-2xl lg:text-3xl font-bold text-[#3B0447] leading-[1.25] lg:leading-[1.25] max-w-[22rem]">How to Bind Your Payout Wallet to Your Agency Account?</h3>
                            <div className="h-[2px] w-20 bg-[#3B0447] my-4"></div>
                            <ul className="list-decimal pl-6 space-y-2 text-lg mt-4">
                                <li>Access your <strong>Agency Dashboard</strong></li>
            ...
            <section id="Agency-commission" className="bg-[#FBD2FE] py-12 lg:pt-24 lg:pb-28 scroll-mt-16">
                <div className="mx-auto w-[90%] max-w-5xl text-center">
                    <h2 className="text-4xl lg:text-6xl font-bold text-[#3B0447] heading-shadow leading-[1.25] lg:leading-[1.25]">
                        Chamet Agency Commission Structure
                    </h2>
                    <p className="md:text-xl pt-4">The Agency commission is determined by the total income generated by all affiliated broadcasters and sub-Agents over the last 30 days. This allows Agents to earn a percentage of the revenue generated by their network.</p>
                    ...
                    <div className="py-6 w-full max-w-4xl flex flex-col md:flex-row justify-center items-start min-h-[10rem] mx-auto">
                        <div className="md:pt-6 w-full h-full max-w-md mx-auto">
                            ...
                            <p>
                                Commissions are based on the total income earned by your broadcasters and sub-Agents within 30 days.
                            </p>
                            <p>
                                Agents earn between 5% to 30% depending on the team’s total monthly performance.
                            </p>
                            <p><strong>For Broadcasters:</strong></p>
                            <p>
                                Commission = rate × total daily cashable earnings of managed broadcasters.
                            </p>
                            <p><strong>For Sub-Agents:</strong></p>
                            <p>
                                Commission = (your rate − sub-Agent&apos;s rate) × sub-Agent&apos;s broadcaster income.
                            </p>
                        </div>
                    ...
                    <div className="border-[1px] border-black rounded-lg mb-2 w-full md:w-4/5 mx-auto bg-white">
                        ...
                        <p>
                            Agents can refer sub-Agents who then manage their own broadcaster groups. Agents earn a share from sub-Agent performance.
                            <span className="font-semibold">
