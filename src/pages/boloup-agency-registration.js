...
export default function BoloupAgencyRegistration() {
    ...
    <main className="flex items-center justify-center min-h-[95vh] bg-[url('/boloup/main-bg-2.svg')] bg-cover bg-bottom bg-no-repeat text-white relative">
        <div className="flex flex-col lg:flex-row items-center justify-center w-[90%] max-w-5xl 2xl:max-w-6xl mx-auto gap-10 lg:gap-0 2xl:gap-10 pt-16 pb-24">
            <div className="flex flex-col items-center justify-center w-full lg:w-[50%] 2xl:w-[40%]">
            <Image src="/boloup/hero-img.png" alt="Bolo Up" className="w-full h-full max-w-60 pl-10 lg:max-w-[22rem] 2xl:max-w-96 object-cover" width={500} height={500} />
            </div>
            <div className="flex flex-col items-center justify-center w-full lg:w-[50%] 2xl:w-[60%] 2xl:pr-20">
                ...
                <a href="https://boloup.onelink.me/PDV4/fkkgd929" className="bg-[url('/boloup/border.svg')] bg-contain bg-center bg-no-repeat rounded-lg px-8 py-2">
                  <span className="text-white rounded-lg">Download App</span>
                </a>
                <a href="https://boloup.onelink.me/PDV4/lswd1lbe" className="bg-[url('/boloup/border.svg')] bg-contain bg-center bg-no-repeat rounded-lg px-8 py-2">
    ...
    <div className="flex flex-col items-center justify-center text-white pt-12 lg:pt-20 lg:pb-10 relative overflow-hidden" style={{background: "linear-gradient(to bottom, #E41414 10%, #F20831 40%, #AB33C9 100%)"}}>
        <div className="flex flex-col lg:flex-row items-center justify-center gap-[6rem] mx-auto w-[90%] max-w-[75rem] pb-10 lg:pt-10 lg:pb-10 xl:pt-0 xl:pb-10 2xl:pb-8">
            <div className="w-full lg:w-[50%]">
                ...
                <ul className="list-decimal pl-6 pb-10 sm:pb-24 lg:pb-16 xl:pb-28 mt-5 space-y-2">
    ...
    <section className="relative bg-[#101010] text-white pt-12 lg:pt-20 pb-24 lg:pb-52">
      <h2 className="text-2xl lg:text-[44px] font-bold text-center max-w-xl mx-auto px-4">Bolo Up Agency Commission Structure</h2>
