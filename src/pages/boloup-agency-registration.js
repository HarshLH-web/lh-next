  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        website_link: "https://lhtalentagency.com/boloup-agency-registration",
        ip_address: ipAddress,
      };

      const response = await fetch("https://webpanel.store/api/boloupdata", {
        method: "POST",
